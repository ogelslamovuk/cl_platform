...
const DEFAULT_SEAT_MAP_LAYOUTS: SeatMapLayout[] = [
  ...
  defaultLayout("layout_palace_demo_chamber", "venue_palace_demo_chamber", "hall_palace_demo_chamber", "Дворец Республики · demo-зал 16x20", 16, 20),
...
const DEFAULT_VENUE_REGISTRY: VenueRegistryRecord[] = [
  ...
  },
  {
    ...
    description: "Demo-зал филармонии со схемой мест до 500 зрителей.",
    capacity: 240,
    status: "approved",
  ...
  },
  {
    ...
    description: "Театральная demo-площадка с компактной рассадкой.",
    capacity: 216,
    status: "approved",
  ...
  },
  {
    ...
    description: "Demo-зал Дворца Республики со схемой мест до 500 зрителей.",
    capacity: 320,
    status: "approved",
    halls: [{ hallId: "hall_palace_demo_chamber", venueId: "venue_palace_demo_chamber", name: "Demo-зал", capacity: 320, hasSeatMap: true, layoutId: "layout_palace_demo_chamber" }],
  },
  {
